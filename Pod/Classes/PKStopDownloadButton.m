...
- (void)updateAppearance {
    ...
    switch (self.state) {
        case kPKStopDownloadButtonState_Resume:
            [self.stopButton setImage:[UIImage imageWithImage:[UIImage imageNamed:@"DownloadButton/play_1"] convertToSize:_stopButtonWidth] forState:UIControlStateNormal];
            break;
        case kPKStopDownloadButtonState_Paused:
            [self.stopButton setImage:[UIImage imageWithImage:[UIImage imageNamed:@"DownloadButton/pause_1"] convertToSize:_stopButtonWidth] forState:UIControlStateNormal];
            break;
        default:
